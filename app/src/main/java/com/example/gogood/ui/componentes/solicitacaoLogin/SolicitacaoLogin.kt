package com.example.gogood.ui.componentes.solicitacaoLogin
...
fun SolicitacaoLoginPreview(modifier: Modifier = Modifier) {
    GoGoodTheme {
        SoliciatacaoLogin(modifier = modifier, navController = rememberNavController())
    }
}